...
import type { UserSettingsInput } from "@/lib/validations/users";
import { userSettingsSchema } from "@/lib/validations/users";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { password, phone, address } = validated.data;
